...
#' \deqn{E[Y(t)|X_1(t), \cdots, X_p(t)] = \beta_0(t) + \sum_{j=1}^p\beta_j(t)\int_0^{\Delta_j}\gamma_j(s)X_j(t-s)ds} 
#' for \eqn{t\in[\max_j\{\Delta_j\}, T]} with a suitable \eqn{T>0}. 
#' Write \eqn{\alpha_j(t, s)=\beta_j(t)\gamma_j(s). It becomes 
#' \deqn{E[Y(t)|X_1(t), \cdots, X_p(t)] = \beta_0(t) + \sum_{j=1}^p\int_0^{\Delta_j}\alpha_j(t, s)X_j(t-s)ds}}. 
